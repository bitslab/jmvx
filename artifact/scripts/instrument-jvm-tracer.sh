...
$JAVA_HOME/bin/java $DEBUG $FILE_NAME -Dlogfile="instrumenter.log" -DlogNatives="true" -cp $JMVX_JAR edu.uic.cs.jmvx.Main -instrument $JAVA_HOME/jre/lib/rt.jar $INSTALL_DIR/tracer
