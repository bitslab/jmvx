...
$JAVA_HOME/bin/java $DEBUG $FILE_NAME -Dsync=false -Dlogfile="instrumenter.log" -cp $JMVX_JAR edu.uic.cs.jmvx.Main -instrument $JAVA_HOME/jre/lib/rt.jar $INSTALL_DIR/nosync
