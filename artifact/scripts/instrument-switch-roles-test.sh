...
$JAVA_HOME/bin/java -Dlogfile="instrumenter.log" $DEBUG $FILE_NAME -cp $JMVX_JAR edu.uic.cs.jmvx.Main -instrument $SOURCE_DIR/SwitchRolesTest.class $TARGET_DIR
$JAVA_HOME/bin/java -Dlogfile="instrumenter.log" $DEBUG $FILE_NAME -cp $JMVX_JAR edu.uic.cs.jmvx.Main -instrument $SOURCE_DIR/SwitchRolesTest\$DoSomething.class $TARGET_DIR
