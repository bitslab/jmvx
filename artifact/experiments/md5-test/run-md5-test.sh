...
$JAVA_HOME/bin/java -Dlogfile=$LOGFILE -DreadsFromDisk=true -Dreps=1 -Xbootclasspath/p:$INSTALL_DIR/rt.jar:$JMVX_JAR $DEBUG $INPUT_ROLE -cp $TEST_INSTRUMENTED/target edu.uic.cs.jmvx.md5.MD5Test $FILESIZE $REPS $BUFFER_LENGTH