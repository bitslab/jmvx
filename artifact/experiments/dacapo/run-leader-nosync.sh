...
$JAVA_HOME/bin/java $MEM -DjunkPort=10001 -Dlogfile="leader.log" $CIRC $DUMP -Xbootclasspath/p:$INSTALL_DIR/nosync/rt.jar:$JMVX_JAR $DEBUG $INPUT_ROLE -cp $DACAPO_INSTRUMENTED_NOSYNC Harness $@
