...
$JAVA_HOME/bin/java -Dlogfile="leader.log" -Xbootclasspath/p:$INSTALL_DIR/rt.jar:$JMVX_JAR $DEBUG $INPUT_ROLE -cp $JMVX_BENCH_INSTRUMENTED/target/$JMVX_BENCH_JAR demos.echoserver.EchoServer
