...
$JAVA_HOME/bin/java -Dlogfile="leader.log" -DlogNatives="true" $DUMP -Xbootclasspath/p:$INSTALL_DIR/tracer/rt.jar:$JMVX_JAR $DEBUG $INPUT_ROLE -cp $JMVX_BENCH_INSTRUMENTED/target/$JMVX_BENCH_JAR org.h2.tools.Server -tcp
