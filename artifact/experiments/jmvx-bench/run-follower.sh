...
$JAVA_HOME/bin/java -Dlogfile="follower.log" $MEM $CIRC $DUMP $OPS -Xbootclasspath/p:$INSTALL_DIR/rt.jar:$JMVX_JAR $DEBUG $INPUT_ROLE -cp $JMVX_BENCH_INSTRUMENTED/target/$JMVX_BENCH_JAR org.h2.tools.Server -tcp
#removed -web -trace
