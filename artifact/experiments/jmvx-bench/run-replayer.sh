...
$JAVA_HOME/bin/java -DrecordingDir="rec" -Dlogfile="follower.log" $MEM $OPS $DUMP -Xbootclasspath/p:$INSTALL_DIR/rt.jar:$JMVX_JAR $DEBUG $INPUT_ROLE -cp $JMVX_BENCH_INSTRUMENTED/target/$JMVX_BENCH_JAR org.h2.tools.Server -tcp
#removed -web -trace
