...
$JAVA_HOME/bin/java $MEM -DlogNatives="true" -DrecordingDir="rec" $OPS -Dlogfile="follower.log" -Xbootclasspath/p:$INSTALL_DIR/tracer/rt.jar:$JMVX_JAR $DEBUG $INPUT_ROLE -cp $DACAPO_CHOPIN_INSTRUMENTED Harness $DUMP $@
