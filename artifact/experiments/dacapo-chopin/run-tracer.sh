...
$JAVA_HOME/bin/java -Dlogfile="leader.log" -DlogNatives="true" -Xbootclasspath/p:$INSTALL_DIR/tracer/rt.jar:$JMVX_JAR $DEBUG $INPUT_ROLE -cp $DACAPO_CHOPIN_INSTRUMENTED Harness $DUMP $@
