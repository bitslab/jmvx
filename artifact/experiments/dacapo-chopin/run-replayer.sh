...
$JAVA_HOME/bin/java $MEM -DrecordingDir="rec" $OPS -Dlogfile="follower.log" -Xbootclasspath/p:$INSTALL_DIR/rt.jar:$JMVX_JAR $DEBUG $INPUT_ROLE -cp $DACAPO_CHOPIN_INSTRUMENTED Harness $DUMP $@
