...
$JAVA_HOME/bin/java -Dlogfile=$LOGFILE -Xbootclasspath/p:$INSTALL_DIR/rt.jar:$JMVX_JAR $DEBUG $INPUT_ROLE -cp $TEST_INSTRUMENTED/target edu.uic.cs.jmvx.switchroles.SwitchRolesTest